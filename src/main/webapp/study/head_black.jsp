		...
		<div class="page-container" id="nav">
			...
			<div id="logo" class="logo">
				<a style="background: url(${pageContext.request.contextPath }/study/img/logo.png) center center no-repeat"
					href="index" target="_self" class="hide-text" title="首页">兄弟连</a>
			</div>
			...
			<div id="login-area">
				<ul class="header-unlogin clearfix">
					<li class="header-signin"><a href="#" id="example1">登录</a></li>
					<li class="header-signup"><a href="#" id="example2">注册</a></li>
				</ul>
			</div>
			...
			<div id="search_top_input" class="float_l top_input">
				...
				<img class="img_sousuo bianshou" src="${pageContext.request.contextPath }/study/img/uiz4.png" onclick="loadsearch1()"/>
			</div>
