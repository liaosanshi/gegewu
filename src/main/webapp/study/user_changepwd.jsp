...
<!--              <div class="info-box clearfix">
            ...
            <div class="info-box clearfix"><label class="pull-left">新密码</label><div class="pull-left"><input id="yyy_newpass" type="password"  name="newpassword"/></div>
            </div>
            <div class="info-box clearfix"><label class="pull-left">确认新密码</label><div class="pull-left"><input id="yyy_submitpass"  type="password" /><span id="sgy_result"></span></div>
            </div>
