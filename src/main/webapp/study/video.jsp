							...
							<div class="col-md-12">
								<div id="willesPlay">
									<div class="playHeader">
										<div id="hahaha" class="videoName">Oracle</div>
									</div>
...
<script type="text/javascript">
$(function(){
	var vid = getParamString("vid");
	loadVideo(vid);
});
	
	function loadVideo(vid){
		$.ajax({
			url:VIDEO_SERVICE+"/course/video",
			type:"get",
			data:{"id":vid},
			dataType:"json",
			success:function(result){
				if(result.code == 0){
					...
					$("#playVideo").html("<source id='video_url' src= '${pageContext.request.contextPath}/study/video/oracle/"+video.url+"' type='video/mp4'></source>");
					$("#hahaha").html(video.name);
					/* $("#video_url").attr("src","${pageContext.request.contextPath}/study/video/oracle/"+video.url+""); */
					var evaluates = video.evaluates;
					for(var i = 0;i < evaluates.length; i ++){
						...
						str += '			<a href="#" class="wenda-head"   title="'+evaluate.user.nickName+'">';
						str += '				<img src="${pageContext.request.contextPath}/study/images/'+evaluate.user.image+'" alt="'+evaluate.user.nickName+'" width="40">';
						str += '				<i class="icon-ques-revert nofinish"></i> </a>';
						str += '		</div>';
						str += '		<div class="wendaslider">';
						str += '			<h2 class="wendaquetitle">';
						str += '				<a href="#"  title="'+evaluate.user.nickName+'" class="wenda-nickname">'+evaluate.user.nickName+'</a>';
						str += '				<div class="wendatitlecon">';
						str += '					<a href="#" class="wendatitle"> <b> '+evaluate.context+' </b> </a>';
						str += '				</div>';
						str += '			</h2>';
						str += '			<div class="replycont clearfix">';
						str += '				<div class="fl replydes">';
						str += '					<span class="replysign praise"> <a href="#" title="泡哥6081133" class="nickname"> </a>  </span> ';
						str += '					<span class="replydet"></span>';
						str += '				</div>';
						str += '			</div>';
						str += '			<div class="replymegfooter clearfix">';
						str += '				<div class="wenda-time l">';
						str += '					<span>'+evaluate.publishTime+'</span>';
						str += '				</div>';
						str += '				<a href="answer.jsp" class="replynumber r hasanswernum"> <span class="ys">';
						str += '						<b class="numShow"></b> <span class="number"></span>';
						str += '				</span> <span class="browsenum"> <b class="numShow"></b>';
						str += '				<span class="number"></span>';
						str += '				</span>';
						str += '				</a>';
						str += '			</div>';
						str += '		</div>';
